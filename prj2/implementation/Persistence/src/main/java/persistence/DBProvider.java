...
public class DBProvider {
    ...
    static DataSource getDataSource(final String sourceName) {
        ...
        return cache.computeIfAbsent(sourceName,
                (s) -> {
                    Properties props = properties("db.properties");
    ...
    static Properties properties(String propFileName) {
        ...
        try (InputStream inputStream = DBProvider.class.getClassLoader().getResourceAsStream(propFileName)) {
...
// try (InputStream dbProperties =
// DBProvider.class.getClassLoader().getResourceAsStream("db.properties");) {
// p.load(dbProperties);
...
// // Assembler project is working directory. In this case
